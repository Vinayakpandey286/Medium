...
// node_modules/@vinayakpandey286/medium-common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@vinayakpandey286/medium-common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    Object.defineProperty(exports, "__esModule", { value: true });
...
blogRouter.use(async (c, next) => {
  ...
  if (c.req.header("authorization") && c.req.header("authorization")?.startsWith("Bearer")) {
    try {
      ...
      const userId = await verify2(token || "", c.env.JWT_SECRET);
      if (userId) {
